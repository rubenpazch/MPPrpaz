	...
	List<Address> addresses = new ArrayList<Address>() {
		{
			...
			add(new Address("601 Central", "Mountain View", "CA", "194707"));
		}
	};
	@SuppressWarnings("serial")
	public List<Author> allAuthors = new ArrayList<Author>() {
		{
			...
			add(new Author("Mary", "Per", "123-422-2663", addresses.get(4), "Known for her clever style."));
		}
	};
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			...
			add(new Book("43-56884", "Mary's First Day of School", 7, Arrays.asList(allAuthors.get(5))));
		}
	};
